            ...
            <div style="width:35%" class="h-100 overflow-hidden scroll-container" style="font-size:0.8em;">
                <div class="h-auto d-flex flex-column scroll-content">
                    <div class="d-flex justify-content-center">
                        <div class="card text-center text-white bg-success  w-100" style="margin-left:15px;">
                ...
                if (queuePanggil.length > 0) {
                    queuePanggil.forEach((value, index) => {
                        if (!isPlay) {
                            ...
                            setTimeout(function() {
                                responsiveVoice.speak("Nomor Antrian, " + value.antrian + ",segera menuju, ke, loket, " + value.loket + ", Terimakasih", "Indonesian Female", {
                                    rate: 0.9,
                                    pitch: 1,
                                    volume: 1,
                                    onend: () => {
